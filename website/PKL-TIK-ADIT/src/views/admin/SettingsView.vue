        ...
        <div class="grid gap-5 xl:grid-cols-[320px_minmax(0,1fr)]">
            <aside class="section-panel overflow-hidden">
                <div class="flex flex-col items-center px-6 py-8 text-center">
                    <span class="grid size-24 place-items-center rounded-full bg-brand-50 text-3xl font-bold text-brand-700">{{ initials }}</span>
                    <h2 class="mt-5 text-xl font-bold text-navy">{{ auth.user?.name }}</h2>
            ...
            <section class="section-panel">
                ...
                <form v-if="activeTab === 'profile'" class="grid gap-5 p-5 md:grid-cols-[200px_1fr] md:p-7" @submit.prevent="saveProfile">
                ...
                <form v-else-if="activeTab === 'password'" class="grid gap-5 p-5 md:grid-cols-[200px_1fr] md:p-7" @submit.prevent="savePassword">
